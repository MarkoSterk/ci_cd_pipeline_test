...
//    public OsebeRest(){
//        osebe.add(new Oseba("Martin", "Krpan", "martin.krpan@email.com"));
//        osebe.add(new Oseba("Mojca", "Pokrajculja", "moja.pokrajculja@email.si"));
//    }
//
//    private List<Oseba> osebe = new ArrayList<>();

    @Autowired
    private OsebeDao dao;
    @Autowired
